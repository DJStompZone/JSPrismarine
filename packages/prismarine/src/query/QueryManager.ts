        ...
        return new Promise(async (resolve, reject) => {
            ...
            switch (type) {
                case QueryType.Handshake: {
                    ...
                    // TODO await this.server.getRaknet().sendBuffer(res.getBuffer(), rinfo.getAddress(), rinfo.getPort());
                ...
                case QueryType.Stats: {
                    ...
                    res.append(
                        Buffer.from(
                            `\0${[
                                ...
                                'maxplayers',
                                // TODO this.server.getRaknet().getName().getMaxPlayerCount(),
                                'hostport',
                    ...
                    // TODO await this.server.getRaknet().sendBuffer(res.getBuffer());
